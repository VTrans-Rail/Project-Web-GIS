...
def dynSegStatusUpdates
    try:
        ...
        #Calculate Field VRLID
        arcpy.CalculateField_management(DDEV_PROJ_Projects_Status_Updates_View2, "GDB_Rail.RAIL_ADMIN.PROJ_StatusUpdates.VRLID", "[GDB_Rail.RAIL_ADMIN.PROJ_Projects.VRLID]", "VB", "")

        #Calculate Field FromMP
        arcpy.CalculateField_management(DDEV_PROJ_Projects_Status_Updates_View2, "GDB_Rail.RAIL_ADMIN.PROJ_StatusUpdates.FromMP", "[GDB_Rail.RAIL_ADMIN.PROJ_Projects.FromMP]", "VB", "")

        #Calculate Field ToMP
        arcpy.CalculateField_management(DDEV_PROJ_Projects_Status_Updates_View2, "GDB_Rail.RAIL_ADMIN.PROJ_StatusUpdates.ToMP", "[GDB_Rail.RAIL_ADMIN.PROJ_Projects.ToMP]", "VB", "")

        #Make Table View of project status master
        arcpy.MakeTableView_management(DDEV_PROJ_Status_Updates_Table, DDEV_PROJ_Projects_Status_Updates_View3, "ToMP is null", "", "OBJECTID OBJECTID VISIBLE NONE;ProjectName ProjectName VISIBLE NONE;Status Status VISIBLE NONE;Action Action VISIBLE NONE;LatestConstEst LatestConstEst VISIBLE NONE;EnvAllClear EnvAllClear VISIBLE NONE;UtilClear UtilClear VISIBLE NONE;ROWClear ROWClear VISIBLE NONE;RRClear RRClear VISIBLE NONE;AdvertiseTarget AdvertiseTarget VISIBLE NONE;ProjectManager ProjectManager VISIBLE NONE;created_user created_user VISIBLE NONE;created_date created_date VISIBLE NONE;last_edited_user last_edited_user VISIBLE NONE;last_edited_date last_edited_date VISIBLE NONE;VRLID VRLID VISIBLE NONE;FromMP FromMP VISIBLE NONE;ToMP ToMP VISIBLE NONE")

        #Make Route Event Point Layer project status table view
        Point_Events = "lyrPoints"
        arcpy.MakeRouteEventLayer_lr(Rail_LRS, "VRLID", DDEV_PROJ_Projects_Status_Updates_View3, "VRLID POINT FromMP", Point_Events, "", "NO_ERROR_FIELD", "NO_ANGLE_FIELD", "NORMAL", "ANGLE", "LEFT", "POINT")
        ...
        #Make Table View of project status master
        arcpy.MakeTableView_management(DDEV_PROJ_Status_Updates_Table, DDEV_PROJ_Projects_Status_Updates_View4, "ToMP is not null", "", "OBJECTID OBJECTID VISIBLE NONE;ProjectName ProjectName VISIBLE NONE;Status Status VISIBLE NONE;Action Action VISIBLE NONE;LatestConstEst LatestConstEst VISIBLE NONE;EnvAllClear EnvAllClear VISIBLE NONE;UtilClear UtilClear VISIBLE NONE;ROWClear ROWClear VISIBLE NONE;RRClear RRClear VISIBLE NONE;AdvertiseTarget AdvertiseTarget VISIBLE NONE;ProjectManager ProjectManager VISIBLE NONE;created_user created_user VISIBLE NONE;created_date created_date VISIBLE NONE;last_edited_user last_edited_user VISIBLE NONE;last_edited_date last_edited_date VISIBLE NONE;VRLID VRLID VISIBLE NONE;FromMP FromMP VISIBLE NONE;ToMP ToMP VISIBLE NONE")

        #Make Route Event Line Layer project status table view
        Line_Events = "lyrLines"
        arcpy.MakeRouteEventLayer_lr(Rail_LRS, "VRLID", DDEV_PROJ_Projects_Status_Updates_View4, "VRLID LINE FromMP ToMP", Line_Events, "", "NO_ERROR_FIELD", "NO_ANGLE_FIELD", "NORMAL", "ANGLE", "LEFT", "POINT")

        # dynSegStatusUpdates: Feature Class to Feature Class (2)
